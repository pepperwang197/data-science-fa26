...
- There seems to generally be a proportional relationship between price and carat, but the price of individual diamonds ranges widely
- There are many more diamonds on a round number of carats (1, 1.5, 2) than on any other numbers.
...
- Most of the diamonds on the lower end of the price range are worse quality.
